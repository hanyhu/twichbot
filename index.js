...
admins = ["609383473815355392", "828874908263120936", "529165692055060525"],
config = {
    "837669857608466473": 500,
    "835293850121666566": 400,
    "836726066810323015": 300,
    "835293850121666565": 300,
    "835293850121666564": 200,
    "835293850121666563": 100,
    "837490664400355399": 25,
    "835334558600658975": 1,
} 
...
if (command === "buy") {
    message.channel.send(new Discord.MessageEmbed()
        .setDescription(`$25 for Lifetime, DM **Drippy.#7283** for more info`)
        .setColor("PURPLE")
        .setFooter(message.guild.name, message.guild.iconURL({
            dynamic: true
        }))
